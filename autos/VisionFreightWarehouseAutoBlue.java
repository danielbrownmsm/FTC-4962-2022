...
public class VisionFreightWarehouseAutoBlue extends LinearOpMode {
   ...
   public void runOpMode() {
      ...
      autoCommand = new SequentialCommand(
        ...
        new WaitCommand(200), // wait for like a second cause idk it's not working
        new SetTurntableCommand(arm, 40),
        new WaitCommand(500),
        new DriveDistance(drivetrain, -15), //TODO use correct distance
        new WaitCommand(1000),
        //new DriveCommand(drivetrain, 0, 0),
        new SetLinearSlide(arm, 5.5), //TODO use correct distance
        new WaitCommand(1000),
